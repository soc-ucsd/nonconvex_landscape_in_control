...
[P_opt, Gamma_opt, tmin] = find_P_LQG(AK,BK,CK,J_opt,A,B2,C2,B1,C1,D11,D12,D21);
...
[P_mincx, Gamma_mincx, tmin] = find_P_LQG...
    (K_mincx.AK,K_mincx.BK,K_mincx.CK,J_recovered_mincx,A,B2,C2,B1,C1,D11,D12,D21);
...
[P_solver, Gamma_solver, tmin] = find_P_LQG...
    (K_mincx.AK,K_mincx.BK,K_mincx.CK,J_recovered_solver,A,B2,C2,B1,C1,D11,D12,D21);