...
% J_hifoo ~ J_our_lmi_mincx ~ J_our_lmi_solver
% < J_hinfsyn_lmi < J_hinfsyn_riccati
...
[K_Hifoo, J_hifoo] = hifoo(sys_struct, 1, options); % order 1
...
% hinfsyn(sys_ss, ny, nu, gammaTry) % one can specify to have better
% performance
